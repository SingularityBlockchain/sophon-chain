            ...
            SubCommand::with_name("distribute-tokens")
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in SOPHON"),
                )
                .arg(
            ...
            SubCommand::with_name("distribute-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_vlx")
                        ...
                        .long("unlocked-vlx")
                        .takes_value(true)
                        .value_name("SOPHON_AMOUNT")
                        .help("Amount of SOPHON to put in system account to pay for fees"),
                )
                .arg(
